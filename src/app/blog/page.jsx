...
export default function BlogsPage() {
  const blogs = [
    ...
    },
    {
      ...
      description:
        "Build responsive and modern UIs quickly using Tailwind CSS 3.",
      date: "4/01/2024",
      readTime: "6 min read",
    ...
    },
    {
      ...
      description:
        "Explore the latest updates in React 18 and how to use them.",
      date: "4/10/2024",
      readTime: "7 min read",
    ...
    },
    {
      ...
      description:
        "How to create a content-rich blog using Next.js and Markdown.",
      date: "5/10/2024",
      readTime: "6 min read",
  ...
  return (
    <section
      className="relative py-16 px-4 md:px-8 lg:px-12 xl:px-20 overflow-hidden"
      style={{
      ...
      <div className="relative pt-10 z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {blogs.map((blog) => (
            <div
              key={blog.id}
              className="border border-gray-100 rounded-xl p-6 shadow bg-white/90 backdrop-blur-sm hover:shadow-lg transition duration-300 flex flex-col justify-between"
            >
              <div>
                <h3 className="text-[16px] textRed font-semibold mb-2">
                  {blog.title}
                </h3>
